...
class CreateProductController {
    handle(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const createProductServices = new CreateProductServices_1.CreateProductServices();
            if (!req.files || Object.keys(req.files).length === 0) {
                ...
                const product = yield createProductServices.execute({ name, price, description, banner: resultFile.url, category_id });
